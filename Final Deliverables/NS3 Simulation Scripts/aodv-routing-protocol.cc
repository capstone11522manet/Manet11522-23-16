 ...
 * Blackhole simulation code after Shalini Satre and Mohit P. Tahiliani - Blackhole Attack Simulation in ns-3 __ Modifications for current version by Tristan Hore
 */
...
RoutingProtocol::RecvRequest(Ptr<Packet> p, Ipv4Address receiver, Ipv4Address src)
{
    ...
    //Mod as per Shalini Satre by Tristan Hore
    if (IsMalicious || m_routingTable.LookupRoute(dst, toDst))
    {
            ...
            toDst.GetValidSeqNo()))
        {
            ...
            //these lines should increment the sequence number but for some reason dont
